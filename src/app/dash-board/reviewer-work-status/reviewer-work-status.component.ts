...
@Component({
  selector: 'app-reviewer-work-status',
  templateUrl: './reviewer-work-status.component.html',
  styleUrls: ['./reviewer-work-status.component.css']
})
export class ReviewerWorkStatusComponent implements OnInit {
